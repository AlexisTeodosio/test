...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 30 oct. 2025 à 08:33
...
--
CREATE DATABASE IF NOT EXISTS `Alexis_cinema` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `Alexis_cinema`;
...
INSERT INTO `Film` (`idFilm`, `titre`, `annee`, `idPersonne`, `idGenre`, `resume`, `idPays`) VALUES
...
(65, 'Sexy dance', 2006, 229, 11, 'Tyler Gage a grandi dans les bas-fonds de Baltimore et possède un don pour le hip-hop. Un soir, il entre par effraction dans une école d\'art. Arrêté par la police, le jeune homme est condamné à effectuer des heures de travaux d\'intérêt général dans cette même école pour réparer ses dégâts. Nora est issue d\'une famille bourgeoise qui finance ses études de danse classique.', 'USA'),
(66, 'Pirates des Caraïbes - Le Secret du coffre maudit', 2006, 233, 7, 'Will Turner et Elizabeth Swann sont arrêtés pour trahison par Lord Beckett. Ce dernier veut obliger Will à récupérer le compas magique de Jack Sparrow. De son côté, Jack a bien des ennuis. Treize ans plus tôt, il a signé un pacte avec Davy Jones, le maître des sept mers. En échange de son âme, Jones lui avait rendu le commandement du Black Pearl. Jones, qui a lancé un monstre aux trousses de Jack, réclame aujourd\'hui son dû.', 'USA'),
(67, 'Superman Returns', 2006, 237, 14, 'Alors qu\'un ennemi de longue date, Lex Luthor, tente de l\'affaiblir en lui dérobant tous ses superpouvoirs, Superman doit faire face à un problème d\'un autre genre : Lois Lane, la femme qu\'il aime, est partie mener une nouvelle vie loin de lui. L\'a-t-elle vraiment oublié ? Le retour de Superman sera donc ponctué de nombreux défis puisqu\'il devra se rapprocher de son amour tout en retrouvant sa place au sein d\'une société qui semble ne plus avoir besoin de lui.', 'USA'),
(68, 'Arthur et les Minimoys', 2006, 242, 7, 'Afin de sauver la maison de sa grand-mère de l\'action d\'un entrepreneur, un garçon de 10 ans se lance sur les traces d\'un trésor dont lui parlait son grand-père. Il pénètre alors un monde de créatures miniatures qui vivent en harmonie parfaite avec la nature. La princesse Selenia et son jeune frère Betameche se joignent à lui dans la recherche du trésor et les compagnons découvrent en chemin que le grand-père, que l\'on croyait disparu depuis longtemps, ne l\'est peut-être pas.', 'FR'),
(69, 'La Nuit au musée 1', 2006, 246, 12, 'Récemment embauché comme agent de sécurité au Muséum d\'histoire naturelle de New York, Larry fait une découverte stupéfiante lors de sa première nuit de travail: tout le musée -- animaux empaillés, figures de cire, statues -- prend vie à la nuit tombée. Face à l\'invasion des Huns, à l\'escapade d\'un tyrannosaure et à un insupportable singe farceur, Larry se retrouve vite débordé dans son nouvel emploi.', 'USA'),
(70, 'Da Vinci Code ', 2006, 250, 7, 'Une nuit, le professeur Robert Langdon, éminent spécialiste de l\'étude des symboles, est appelé d\'urgence au Louvre : le conservateur du musée a été assassiné, mais avant de mourir, il a laissé de mystérieux symboles... Avec l\'aide de la cryptologue Sophie Neveu, Langdon va mener l\'enquête et découvrir des signes dissimulés dans les oeuvres de Léonard de Vinci.', 'USA');
...
INSERT INTO `Personne` (`idPersonne`, `nom`, `prenom`, `anneeNaissance`) VALUES
...
(229, 'Fletcher', 'Anne', 1966),
(230, 'Channing', 'Tatum', 1980),
(231, 'Dewan', 'Jenna', 1980),
(233, 'Sandberg', ' Espen ', 1971),
(235, 'Bloom', 'Orlando', 1977),
(236, 'Knightley', 'Keira', 1985),
(237, 'Donner', 'Richard', 1930),
(238, 'Routh', 'Brandon', 1979),
(239, 'Bosworth', 'Kate', 1983),
(240, 'Langella', 'Frank', 1938),
(241, 'Sidora', 'Drew', 1986),
(242, 'Besson', 'Luc', 1959),
(243, 'Kelsch', 'Barbara', 1972),
(244, 'Laquière', 'Toinette', 1975),
(245, 'Royer', 'Régis', NULL),
(246, 'Levy', 'Shawn', 1968),
(247, 'Stiller', 'Ben', 1965),
(248, 'Gervais', 'Ricky', 1961),
(249, 'Williams', 'Robin', 1951),
(250, 'Howard', 'Ron ', 1954),
(251, 'Hanks', 'Tom ', 1956),
(252, 'Tautou', 'Audrey', 1976),
(253, 'Reno ', 'Jean ', 1948);
...
INSERT INTO `Role` (`idFilm`, `idPersonne`, `nomRole`) VALUES
(1, 15, 'John Ferguson'),
...
(65, 241, 'Lucy Avila'),
(66, 14, 'Jack Sparrow'),
(66, 235, 'William Turner'),
(66, 236, 'Elizabeth Swann'),
(67, 238, 'Clark Kent'),
(67, 239, 'Lois Lane'),
(67, 240, 'Perry White'),
(68, 243, 'Arthur'),
(68, 244, 'princesse Selenia'),
(68, 245, 'le roi des Minimoys'),
(69, 247, 'Larry Daley'),
(69, 248, 'Dr McPhee'),
(69, 249, 'Theodore Roosevelt'),
(70, 251, 'Robert Langdon'),
(70, 252, 'Sophie Neveu'),
(70, 253, 'Bézu Fache');
...
--
ALTER TABLE `Film`
  MODIFY `idFilm` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
--
ALTER TABLE `Personne`
  MODIFY `idPersonne` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=254;
...
--
ALTER TABLE `Film`
  ADD CONSTRAINT `films_ibfk_1` FOREIGN KEY (`idPersonne`) REFERENCES `Personne` (`idPersonne`),
  ADD CONSTRAINT `films_ibfk_2` FOREIGN KEY (`idGenre`) REFERENCES `Genre` (`idGenre`),
...
--
ALTER TABLE `Role`
  ADD CONSTRAINT `roles_ibfk_1` FOREIGN KEY (`idFilm`) REFERENCES `Film` (`idFilm`),
  ADD CONSTRAINT `roles_ibfk_2` FOREIGN KEY (`idPersonne`) REFERENCES `Personne` (`idPersonne`);
COMMIT;
